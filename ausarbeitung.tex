...
Eine \ac{pwa} ist dabei jedoch keine klar abgegrenzte Technologie, sondern vielmehr eine Webanwendung, welche bestimmte Eigenschaften erfüllt.

Der Begriff setzt sich dabei aus \enquote{Progressive} und \enquote{Web App} zusammen.
\enquote{Web App} bezeichnet die Art der Anwendung.
\acp{pwa} basieren auf HTML, CSS und JavaScript wie herkömmliche Webanwendungen.
\enquote{Progressive} steht für \enquote{Progressive Enhancement}, was eine Methodik im Webdesign beschreibt. %TODO: Erläutern
