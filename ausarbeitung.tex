...
Das definieren von \enquote{short\_name}, \enquote{name}, \enquote{icons}, \enquote{start\_url} und \enquote{display} ist dabei verpflichtend.

\enquote{short\_name} und \enquote{icons} beschreiben das Aussehen der Verknüpfung.
In der Manifestdatei sollten mehrere Icons in verschiedenen Auflösungen als Pfad angegeben werden.
So kann je nach Auflösung des Gerätes das am besten passende Icon vom Browser gewählt werden.
Der Name wird für den Installationsdialog und als Beschriftung der Verknüpfung verwendet.
...
%TODO start_url: Wo anfangen, wenn Lesezeichen irgendwo

description
background\_color - Ladescreen
scope
theme\_color
cite: webdev, add manifest
